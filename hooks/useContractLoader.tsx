...
const { oneshotPlanetContract } = require("../../onchain/abis/OneshotPlanet")
...
export default function useContractLoader(providerOrSigner, oneshotAddress, config) {
  ...
  }, [providerOrSigner, config.chainId, config.hardhatNetworkName, oneshotAddress]);
